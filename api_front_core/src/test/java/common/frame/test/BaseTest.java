...
public abstract class BaseTest extends AbstractTestNGSpringContextTests{
	...
	public static String client = System.getProperty("client");
	public static String clientOfwx = "wx";
	public static String clientOfh5 = "h5";
	public static String clientOfapp = "app";
